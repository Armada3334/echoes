...
!define DESCRIPTION "RTL-SDR based RF spectrograph for meteor scatter"
!define INSTALLEREXE "Install-${APPNAME}"
!define SRCDIR      "${BASEDIR}\echoes"
!define EXEDIR      "${SRCDIR}\NSIS\win32"	#<--at the end of deploying, the exe and dlls are here
...
#WARNING: these DLLs cannot be replaced with official Soapy binaries that are compiled with MSVC.
!define SOAPYBINDIR "${SRCDIR}\deps\x86_32\Soapy\bin"
!define SOAPYMODDIR "${SRCDIR}\deps\x86_32\Soapy\lib\SoapySDR\modules0.8"
...
!define HELPURL "mailto://gmbertani@users.sourceforge.net" # "Support Information" link
...
VIAddVersionKey "LegalCopyright" "(C)2021 Giuseppe Massimo Bertani"
...
cont:
  ...
  DetailPrint "Installing liquidSDR library"
    ...
    WriteRegExpandStr ${env_hklm} "SOAPY_SDR_PLUGIN_PATH" "$INSTDIR\Soapy\modules0.8"
